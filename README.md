# YouTube Clips
A Firefox extension that lets you clip part of a YouTube video and save it as a video file to share.
...
- Save the clip as a video file at the quality you're watching: WebM in Firefox (MP4 in Chrome, once
  the Chrome version exists). WebM may not play on iPhones.
...
3. Set the start and end, preview it, then **Save video** and share the file.
