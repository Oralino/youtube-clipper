...
- Saving locks the Start/End fields and "Use current time" (see Locked), and disables Preview. Close and the header stay as they are. The Stop saving button gets `aria-describedby` on the saving note.
